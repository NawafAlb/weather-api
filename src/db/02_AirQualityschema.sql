...
DROP TABLE IF EXISTS user_AirQualitydata;
...
CREATE TABLE user_AirQualitydata (
...
CREATE INDEX IF NOT EXISTS idx_lat_lon ON user_AirQualitydata (latitude, longitude);
